...
## Tech Stack & Angular Concepts
- Angular 17 (Standalone Components, Signals)
- TypeScript
- RxJS (Observables, Subjects)
- SCSS (modern design patterns)
- Angular Router (lazy loading, guards, nested routes)
...
```bash
git clone https://github.com/RomeroArias23/to-do-app.git
cd to-do-app
